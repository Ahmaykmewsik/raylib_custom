...
RAYGUIAPI bool GuiWindowBox(RayRectangle bounds, const char *title);                                       // Window Box control, shows a window that can be closed
...
RAYGUIAPI void GuiPanel(RayRectangle bounds);                                                              // Panel control, useful to group controls
RAYGUIAPI RayRectangle GuiScrollPanel(RayRectangle bounds, RayRectangle content, Vector2 *scroll);               // Scroll Panel control

// Basic controls set
RAYGUIAPI void GuiLabel(RayRectangle bounds, const char *text);                                            // Label control, shows text
RAYGUIAPI bool GuiButton(RayRectangle bounds, const char *text);                                           // Button control, returns true when clicked
RAYGUIAPI bool GuiLabelButton(RayRectangle bounds, const char *text);                                      // Label button control, show true when clicked
RAYGUIAPI bool GuiToggle(RayRectangle bounds, const char *text, bool active);                              // Toggle Button control, returns true when active
...
RAYGUIAPI bool GuiCheckBox(RayRectangle bounds, const char *text, bool checked);                           // Check Box control, returns true when active
RAYGUIAPI int GuiComboBox(RayRectangle bounds, const char *text, int active);                              // Combo Box control, returns selected item index
RAYGUIAPI bool GuiDropdownBox(RayRectangle bounds, const char *text, int *active, bool editMode);          // Dropdown Box control, returns selected item
RAYGUIAPI bool GuiSpinner(RayRectangle bounds, const char *text, int *value, int minValue, int maxValue, bool editMode);     // Spinner control, returns selected value
RAYGUIAPI bool GuiValueBox(RayRectangle bounds, const char *text, int *value, int minValue, int maxValue, bool editMode);    // Value Box control, updates input text with numbers
RAYGUIAPI bool GuiTextBox(RayRectangle bounds, char *text, int textSize, bool editMode);                   // Text Box control, updates input text
RAYGUIAPI bool GuiTextBoxMulti(RayRectangle bounds, char *text, int textSize, bool editMode);              // Text Box control with multiple lines
RAYGUIAPI float GuiSlider(RayRectangle bounds, const char *textLeft, const char *textRight, float value, float minValue, float maxValue);       // Slider control, returns selected value
...
RAYGUIAPI void GuiDummyRec(RayRectangle bounds, const char *text);                                         // Dummy control for placeholders
RAYGUIAPI int GuiScrollBar(RayRectangle bounds, int value, int minValue, int maxValue);                    // Scroll Bar control
RAYGUIAPI Vector2 GuiGrid(RayRectangle bounds, float spacing, int subdivs);                                // Grid control
...
RAYGUIAPI int GuiListViewEx(RayRectangle bounds, const char **text, int count, int *focus, int *scrollIndex, int active);      // List View with extended parameters
...
RAYGUIAPI int GuiTextInputBox(RayRectangle bounds, const char *title, const char *message, const char *buttons, char *text);   // Text Input Box control, ask for text
RAYGUIAPI Color GuiColorPicker(RayRectangle bounds, Color color);                                          // Color Picker control (multiple color controls)
RAYGUIAPI Color GuiColorPanel(RayRectangle bounds, Color color);                                           // Color Panel control
RAYGUIAPI float GuiColorBarAlpha(RayRectangle bounds, float alpha);                                        // Color Bar Alpha control
RAYGUIAPI float GuiColorBarHue(RayRectangle bounds, float value);                                          // Color Bar Hue control
...
// Window Box control
bool GuiWindowBox(RayRectangle bounds, const char *title)
{
    ...
    RayRectangle windowPanel = { bounds.x, bounds.y + (float)statusBarHeight - 1, bounds.width, bounds.height - (float)statusBarHeight };
...
void GuiGroupBox(RayRectangle bounds, const char *text)
{
    ...
    // Draw control
    //--------------------------------------------------------------------
    GuiDrawRectangle(RAYGUI_CLITERAL(RayRectangle){ bounds.x, bounds.y, GROUPBOX_LINE_THICK, bounds.height }, 0, BLANK, Fade(GetColor(GuiGetStyle(DEFAULT, (state == GUI_STATE_DISABLED)? BORDER_COLOR_DISABLED : LINE_COLOR)), guiAlpha));
    GuiDrawRectangle(RAYGUI_CLITERAL(RayRectangle){ bounds.x, bounds.y + bounds.height - 1, bounds.width, GROUPBOX_LINE_THICK }, 0, BLANK, Fade(GetColor(GuiGetStyle(DEFAULT, (state == GUI_STATE_DISABLED)? BORDER_COLOR_DISABLED : LINE_COLOR)), guiAlpha));
    GuiDrawRectangle(RAYGUI_CLITERAL(RayRectangle){ bounds.x + bounds.width - 1, bounds.y, GROUPBOX_LINE_THICK, bounds.height }, 0, BLANK, Fade(GetColor(GuiGetStyle(DEFAULT, (state == GUI_STATE_DISABLED)? BORDER_COLOR_DISABLED : LINE_COLOR)), guiAlpha));

    GuiLine(RAYGUI_CLITERAL(RayRectangle){ bounds.x, bounds.y, bounds.width, 1 }, text);
    //--------------------------------------------------------------------
}
...
void GuiLine(RayRectangle bounds, const char *text)
{
    ...
    else
    {
        ...
        GuiDrawRectangle(RAYGUI_CLITERAL(RayRectangle){ bounds.x, bounds.y, LINE_TEXT_PADDING - 2, 1 }, 0, BLANK, color);
        GuiLabel(textBounds, text);
        GuiDrawRectangle(RAYGUI_CLITERAL(RayRectangle){ bounds.x + LINE_TEXT_PADDING + textBounds.width + 4, bounds.y, bounds.width - textBounds.width - LINE_TEXT_PADDING - 4, 1 }, 0, BLANK, color);
    }
    //--------------------------------------------------------------------
}

// Panel control
void GuiPanel(RayRectangle bounds)
{
...
RayRectangle GuiScrollPanel(RayRectangle bounds, RayRectangle content, Vector2 *scroll)
{
    GuiControlState state = guiState;
    ...
    const RayRectangle horizontalScrollBar = { (float)((GuiGetStyle(LISTVIEW, SCROLLBAR_SIDE) == SCROLLBAR_LEFT_SIDE)? (float)bounds.x + verticalScrollBarWidth : (float)bounds.x) + GuiGetStyle(DEFAULT, BORDER_WIDTH), (float)bounds.y + bounds.height - horizontalScrollBarWidth - GuiGetStyle(DEFAULT, BORDER_WIDTH), (float)bounds.width - verticalScrollBarWidth - 2*GuiGetStyle(DEFAULT, BORDER_WIDTH), (float)horizontalScrollBarWidth };
    const RayRectangle verticalScrollBar = { (float)((GuiGetStyle(LISTVIEW, SCROLLBAR_SIDE) == SCROLLBAR_LEFT_SIDE)? (float)bounds.x + GuiGetStyle(DEFAULT, BORDER_WIDTH) : (float)bounds.x + bounds.width - verticalScrollBarWidth - GuiGetStyle(DEFAULT, BORDER_WIDTH)), (float)bounds.y + GuiGetStyle(DEFAULT, BORDER_WIDTH), (float)verticalScrollBarWidth, (float)bounds.height - horizontalScrollBarWidth - 2*GuiGetStyle(DEFAULT, BORDER_WIDTH) };
...
bool GuiButton(RayRectangle bounds, const char *text)
{
    GuiControlState state = guiState;
    bool pressed = false;
...
bool GuiLabelButton(RayRectangle bounds, const char *text)
{
    GuiControlState state = guiState;
    bool pressed = false;
...
bool GuiToggle(RayRectangle bounds, const char *text, bool active)
{
    GuiControlState state = guiState;
...
bool GuiCheckBox(RayRectangle bounds, const char *text, bool checked)
{
    GuiControlState state = guiState;
...
int GuiComboBox(RayRectangle bounds, const char *text, int active)
{
    ...
    RayRectangle selector = { (float)bounds.x + bounds.width + GuiGetStyle(COMBOBOX, COMBO_BUTTON_PADDING),
...
bool GuiDropdownBox(RayRectangle bounds, const char *text, int *active, bool editMode)
{
    GuiControlState state = guiState;
...
bool GuiTextBox(RayRectangle bounds, char *text, int textSize, bool editMode)
{
    GuiControlState state = guiState;
    bool pressed = false;
...
bool GuiSpinner(RayRectangle bounds, const char *text, int *value, int minValue, int maxValue, bool editMode)
{
    GuiControlState state = guiState;
    ...
    RayRectangle spinner = { bounds.x + GuiGetStyle(SPINNER, SPIN_BUTTON_WIDTH) + GuiGetStyle(SPINNER, SPIN_BUTTON_PADDING), bounds.y,
...
bool GuiValueBox(RayRectangle bounds, const char *text, int *value, int minValue, int maxValue, bool editMode)
{
...
float GuiSliderPro(RayRectangle bounds, const char *textLeft, const char *textRight, float value, float minValue, float maxValue, int sliderWidth)
{
    GuiControlState state = guiState;
...
float GuiSlider(RayRectangle bounds, const char *textLeft, const char *textRight, float value, float minValue, float maxValue)
{
    return GuiSliderPro(bounds, textLeft, textRight, value, minValue, maxValue, GuiGetStyle(SLIDER, SLIDER_WIDTH));
}

// Slider Bar control extended, returns selected value
float GuiSliderBar(RayRectangle bounds, const char *textLeft, const char *textRight, float value, float minValue, float maxValue)
{
...
void GuiDummyRec(RayRectangle bounds, const char *text)
{
    GuiControlState state = guiState;
...
// Scroll Bar control
int GuiScrollBar(RayRectangle bounds, int value, int minValue, int maxValue)
{
    GuiControlState state = guiState;
...
int GuiListViewEx(RayRectangle bounds, const char **text, int count, int *focus, int *scrollIndex, int active)
{
    GuiControlState state = guiState;
...
float GuiColorBarAlpha(RayRectangle bounds, float alpha)
{
    ...
    if (state != GUI_STATE_DISABLED)
    {
        ...
        for (int x = 0; x < checksX; x++)
        {
            ...
            {
                RayRectangle check = { bounds.x + x*COLORBARALPHA_CHECKED_SIZE, bounds.y + y*COLORBARALPHA_CHECKED_SIZE, COLORBARALPHA_CHECKED_SIZE, COLORBARALPHA_CHECKED_SIZE };
...
float GuiColorBarHue(RayRectangle bounds, float hue)
{
    GuiControlState state = guiState;
...
Color GuiColorPicker(RayRectangle bounds, Color color)
{
...
int GuiTextInputBox(RayRectangle bounds, const char *title, const char *message, const char *buttons, char *text)
{
...
Vector2 GuiGrid(RayRectangle bounds, float spacing, int subdivs)
{
