...
*
*   #define RLGL[currentContext].IMPLEMENTATION
*       Generates the implementation of the library into the included file.
*       If not defined, the library is in header only mode and can be included in other headers
*       or source files without problems. But only ONE file should hold the implementation.
*
*   #define RLGL[currentContext].RENDER_TEXTURES_HINT
*       Enable framebuffer objects (fbo) support (enabled by default)
*       Some GPUs could not support them despite the OpenGL version
*
*   #define RLGL[currentContext].SHOW_GL_DETAILS_INFO
*       Show OpenGL extensions and capabilities detailed logs on init
*
*   #define RLGL[currentContext].ENABLE_OPENGL_DEBUG_CONTEXT
...
#endif  // RLGL[currentContext].SHOW_GL_DETAILS_INFO
#endif  // GRAPHICS_API_OPENGL_33 || GRAPHICS_API_OPENGL_ES2
#if defined(GRAPHICS_API_OPENGL_11)
...
void rlTextureParameters(unsigned int id, int param, int value)
{
    ...
    switch (param)
    {
        ...
        case RL_TEXTURE_FILTER_ANISOTROPIC:
        {
            ...
            {
                TRACELOG(RL_LOG_WARNING, "GL: Maximum anisotropic filter level supported is %iX", id, RLGL[currentContext].ExtSupported.maxAnisotropyLevel);
...
void rlLoadExtensions(void *loader)
{
...
#if defined(RLGL[currentContext].SHOW_GL_DETAILS_INFO)
    TRACELOG(RL_LOG_INFO, "GL: OpenGL extensions:");
    ...
    */
#else   // RLGL[currentContext].SHOW_GL_DETAILS_INFO
...
#endif  // RLGL[currentContext].IMPLEMENTATION