...
typedef enum {
    ...
    FLAG_WINDOW_MOUSE_PASSTHROUGH   = 0x00100000,   // [CUSTOM] Set to enable mouse passthrough
...
//NOTE: Keys and mouse enums have been OBLITERATED!!!!!
...
RLAPI bool RayIsKeyDown(int key);                             // Check if a key has been pressed once
RLAPI bool RayIsKeyDown(int key);                                // Check if a key is being pressed
...
RLAPI int GetMouseX(int windowID);                            // Get mouse position X
RLAPI int GetMouseY(int windowID);                            // Get mouse position Y
RLAPI Vector2 GetMousePosition(int windowID);                 // Get mouse position XY
RLAPI Vector2 GetMouseDelta(int windowID);                    // Get mouse delta between frames
...
RLAPI void DrawGrid(int slices, float spacing, Color color, float lineIntensity);                        // Draw a grid (centered at (0, 0, 0))
