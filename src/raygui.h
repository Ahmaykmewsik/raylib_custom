...
RAYGUIAPI bool GuiWindowBox(int windowID, RayRectangle bounds, const char *title);                                       // Window Box control, shows a window that can be closed
RAYGUIAPI void GuiGroupBox(RayRectangle bounds, const char *text);                                         // Group Box control with text name
RAYGUIAPI void GuiLine(RayRectangle bounds, const char *text);                                             // Line separator control, could contain text
RAYGUIAPI void GuiPanel(RayRectangle bounds, const char *text);                                            // Panel control, useful to group controls
RAYGUIAPI RayRectangle GuiScrollPanel(int windowID, RayRectangle bounds, const char *text, RayRectangle content, Vector2 *scroll); // Scroll Panel control

// Basic controls set
RAYGUIAPI void GuiLabel(RayRectangle bounds, const char *text);                                            // Label control, shows text
RAYGUIAPI bool GuiButton(int windowID, RayRectangle bounds, const char *text);                                           // Button control, returns true when clicked
RAYGUIAPI bool GuiLabelButton(int windowID, RayRectangle bounds, const char *text);                                      // Label button control, show true when clicked
RAYGUIAPI bool GuiToggle(int windowID, RayRectangle bounds, const char *text, bool active);                              // Toggle Button control, returns true when active
RAYGUIAPI int GuiToggleGroup(int windowID, RayRectangle bounds, const char *text, int active);                           // Toggle Group control, returns active toggle index
RAYGUIAPI bool GuiCheckBox(int windowID, RayRectangle bounds, const char *text, bool checked);                           // Check Box control, returns true when active
RAYGUIAPI int GuiComboBox(int windowID, RayRectangle bounds, const char *text, int active);                              // Combo Box control, returns selected item index
RAYGUIAPI bool GuiDropdownBox(int windowID, RayRectangle bounds, const char *text, int *active, bool editMode);          // Dropdown Box control, returns selected item
RAYGUIAPI bool GuiSpinner(int windowID, RayRectangle bounds, const char *text, int *value, int minValue, int maxValue, bool editMode);     // Spinner control, returns selected value
RAYGUIAPI bool GuiValueBox(int windowID, RayRectangle bounds, const char *text, int *value, int minValue, int maxValue, bool editMode);    // Value Box control, updates input text with numbers
RAYGUIAPI bool GuiTextBox(int windowID, RayRectangle bounds, char *text, int textSize, bool editMode);                   // Text Box control, updates input text
RAYGUIAPI bool GuiTextBoxMulti(int windowID, RayRectangle bounds, char *text, int textSize, bool editMode);              // Text Box control with multiple lines
RAYGUIAPI float GuiSlider(int windowID, RayRectangle bounds, const char *textLeft, const char *textRight, float value, float minValue, float maxValue);       // Slider control, returns selected value
RAYGUIAPI float GuiSliderBar(RayRectangle bounds, const char *textLeft, const char *textRight, float value, float minValue, float maxValue);    // Slider Bar control, returns selected value
RAYGUIAPI float GuiProgressBar(RayRectangle bounds, const char *textLeft, const char *textRight, float value, float minValue, float maxValue);  // Progress Bar control, shows current progress value
RAYGUIAPI void GuiStatusBar(RayRectangle bounds, const char *text);                                        // Status Bar control, shows info text
RAYGUIAPI void GuiDummyRec(int windowID, RayRectangle bounds, const char *text);                                         // Dummy control for placeholders
RAYGUIAPI Vector2 GuiGrid(int windowID, RayRectangle bounds, const char *text, float spacing, int subdivs);              // Grid control, returns mouse cell position

// Advance controls set
RAYGUIAPI int GuiListView(int windowID, RayRectangle bounds, const char *text, int *scrollIndex, int active);            // List View control, returns selected list item index
RAYGUIAPI int GuiListViewEx(int windowID, RayRectangle bounds, const char **text, int count, int *focus, int *scrollIndex, int active);      // List View with extended parameters
RAYGUIAPI int GuiMessageBox(int windowID, RayRectangle bounds, const char *title, const char *message, const char *buttons);                 // Message Box control, displays a message
RAYGUIAPI int GuiTextInputBox(int windowID, RayRectangle bounds, const char *title, const char *message, const char *buttons, char *text, int textMaxSize, int *secretViewActive);   // Text Input Box control, ask for text, supports secret
RAYGUIAPI Color GuiColorPicker(int windowID, RayRectangle bounds, const char *text, Color color);                        // Color Picker control (multiple color controls)
RAYGUIAPI Color GuiColorPanel(int windowID, RayRectangle bounds, const char *text, Color color);                         // Color Panel control
RAYGUIAPI float GuiColorBarAlpha(int windowID, RayRectangle bounds, const char *text, float alpha);                      // Color Bar Alpha control
RAYGUIAPI float GuiColorBarHue(int windowID, RayRectangle bounds, const char *text, float value);                        // Color Bar Hue control
...
typedef enum { BORDER = 0, BASE, GUITEXT, OTHER } GuiPropertyElement;
...
static void SetShapesTexture(Texture2D tex, RayRectangle rec); // -- GuiLoadStyle()
...
static void GuiDrawText(const char *text, RayRectangle bounds, int alignment, Color tint);         // Gui draw text using default font
...
static int GuiScrollBar(int windowID, RayRectangle bounds, int value, int minValue, int maxValue);   // Scroll bar control, used by GuiScrollPanel()
...
// Window Box control
bool GuiWindowBox(int windowID, RayRectangle bounds, const char *title)
{
...
#if defined(RAYGUI_NO_ICONS)
    clicked = GuiButton(windowID, closeButtonRec, "x");
#else
    clicked = GuiButton(windowID, closeButtonRec, GuiIconText(ICON_CROSS_SMALL, NULL));
#endif
...
void GuiGroupBox(RayRectangle bounds, const char *text)
{
    ...
    // Draw control
    //--------------------------------------------------------------------
    GuiDrawRectangle(RAYGUI_CLITERAL(RayRectangle){ bounds.x, bounds.y, RAYGUI_GROUPBOX_LINE_THICK, bounds.height }, 0, BLANK, Fade(GetColor(GuiGetStyle(DEFAULT, (state == STATE_DISABLED)? (int) BORDER_COLOR_DISABLED : (int) LINE_COLOR)), guiAlpha));
    GuiDrawRectangle(RAYGUI_CLITERAL(RayRectangle){ bounds.x, bounds.y + bounds.height - 1, bounds.width, RAYGUI_GROUPBOX_LINE_THICK }, 0, BLANK, Fade(GetColor(GuiGetStyle(DEFAULT, (state == STATE_DISABLED)? (int) BORDER_COLOR_DISABLED : (int) LINE_COLOR)), guiAlpha));
    GuiDrawRectangle(RAYGUI_CLITERAL(RayRectangle){ bounds.x + bounds.width - 1, bounds.y, RAYGUI_GROUPBOX_LINE_THICK, bounds.height }, 0, BLANK, Fade(GetColor(GuiGetStyle(DEFAULT, (state == STATE_DISABLED)? (int) BORDER_COLOR_DISABLED : (int) LINE_COLOR)), guiAlpha));
...
// Line control
void GuiLine(RayRectangle bounds, const char *text)
{
...
// Panel control
void GuiPanel(RayRectangle bounds, const char *text)
{
...
RayRectangle GuiScrollPanel(int windowID, RayRectangle bounds, const char *text, RayRectangle content, Vector2 *scroll)
{
    GuiState state = guiState;
    ...
    RayRectangle horizontalScrollBar = { (float)((GuiGetStyle(LISTVIEW, SCROLLBAR_SIDE) == SCROLLBAR_LEFT_SIDE)? (float)bounds.x + verticalScrollBarWidth : (float)bounds.x) + GuiGetStyle(DEFAULT, BORDER_WIDTH), (float)bounds.y + bounds.height - horizontalScrollBarWidth - GuiGetStyle(DEFAULT, BORDER_WIDTH), (float)bounds.width - verticalScrollBarWidth - 2*GuiGetStyle(DEFAULT, BORDER_WIDTH), (float)horizontalScrollBarWidth };
    RayRectangle verticalScrollBar = { (float)((GuiGetStyle(LISTVIEW, SCROLLBAR_SIDE) == SCROLLBAR_LEFT_SIDE)? (float)bounds.x + GuiGetStyle(DEFAULT, BORDER_WIDTH) : (float)bounds.x + bounds.width - verticalScrollBarWidth - GuiGetStyle(DEFAULT, BORDER_WIDTH)), (float)bounds.y + GuiGetStyle(DEFAULT, BORDER_WIDTH), (float)verticalScrollBarWidth, (float)bounds.height - horizontalScrollBarWidth - 2*GuiGetStyle(DEFAULT, BORDER_WIDTH) };

    // Calculate view area (area without the scrollbars)
    RayRectangle view = (GuiGetStyle(LISTVIEW, SCROLLBAR_SIDE) == SCROLLBAR_LEFT_SIDE)?
    ...
    {
        Vector2 mousePoint = GetMousePosition(windowID);
    ...
    if (hasHorizontalScrollBar)
    {
        ...
        scrollPos.x = (float)-GuiScrollBar(windowID, horizontalScrollBar, (int)-scrollPos.x, (int)horizontalMin, (int)horizontalMax);
    }
    ...
    if (hasVerticalScrollBar)
    {
        ...
        scrollPos.y = (float)-GuiScrollBar(windowID, verticalScrollBar, (int)-scrollPos.y, (int)verticalMin, (int)verticalMax);
    }
    ...
    if (hasHorizontalScrollBar && hasVerticalScrollBar)
    {
        ...
        GuiDrawRectangle(corner, 0, BLANK, Fade(GetColor(GuiGetStyle(LISTVIEW, GUITEXT + (state*3))), guiAlpha));
    }
...
// Label control
void GuiLabel(RayRectangle bounds, const char *text)
{
    GuiState state = guiState;
    ...
    // Draw control
    //--------------------------------------------------------------------
    GuiDrawText(text, GetTextBounds(LABEL, bounds), GuiGetStyle(LABEL, TEXT_ALIGNMENT), Fade(GetColor(GuiGetStyle(LABEL, GUITEXT + (state*3))), guiAlpha));
    //--------------------------------------------------------------------
}

// Button control, returns true when clicked
bool GuiButton(int windowID, RayRectangle bounds, const char *text)
{
    GuiState state = guiState;
    bool pressed = false;
    ...
    GuiDrawText(text, GetTextBounds(BUTTON, bounds), GuiGetStyle(BUTTON, TEXT_ALIGNMENT), Fade(GetColor(GuiGetStyle(BUTTON, GUITEXT + (state*3))), guiAlpha));
    //------------------------------------------------------------------
...
bool GuiLabelButton(int windowID, RayRectangle bounds, const char *text)
{
    GuiState state = guiState;
    bool pressed = false;
...
bool GuiToggle(int windowID, RayRectangle bounds, const char *text, bool active)
{
    GuiState state = guiState;
    ...
    if (state == STATE_NORMAL)
    {
        ...
        GuiDrawText(text, GetTextBounds(TOGGLE, bounds), GuiGetStyle(TOGGLE, TEXT_ALIGNMENT), Fade(GetColor(GuiGetStyle(TOGGLE, (active? TEXT_COLOR_PRESSED : (GUITEXT + state*3)))), guiAlpha));
    }
    else
    {
        ...
        GuiDrawText(text, GetTextBounds(TOGGLE, bounds), GuiGetStyle(TOGGLE, TEXT_ALIGNMENT), Fade(GetColor(GuiGetStyle(TOGGLE, GUITEXT + state*3)), guiAlpha));
    }
    //--------------------------------------------------------------------
...
int GuiToggleGroup(int windowID, RayRectangle bounds, const char *text, int active)
{
    ...
    for (int i = 0; i < itemCount; i++)
    {
        ...
        if (i == active) GuiToggle(windowID, bounds, items[i], true);
        else if (GuiToggle(windowID, bounds, items[i], false) == true) active = i;
...
bool GuiCheckBox(int windowID, RayRectangle bounds, const char *text, bool checked)
{
    GuiState state = guiState;
    ...
    if (checked)
    {
        ...
        GuiDrawRectangle(check, 0, BLANK, Fade(GetColor(GuiGetStyle(CHECKBOX, GUITEXT + state*3)), guiAlpha));
    }

    GuiDrawText(text, textBounds, (GuiGetStyle(CHECKBOX, TEXT_ALIGNMENT) == TEXT_ALIGN_RIGHT)? TEXT_ALIGN_LEFT : TEXT_ALIGN_RIGHT, Fade(GetColor(GuiGetStyle(LABEL, GUITEXT + (state*3))), guiAlpha));
    //--------------------------------------------------------------------
...
int GuiComboBox(int windowID, RayRectangle bounds, const char *text, int active)
{
    GuiState state = guiState;
    ...
    GuiDrawText(items[active], GetTextBounds(COMBOBOX, bounds), GuiGetStyle(COMBOBOX, TEXT_ALIGNMENT), Fade(GetColor(GuiGetStyle(COMBOBOX, GUITEXT + (state*3))), guiAlpha));
    ...
    GuiButton(windowID, selector, TextFormat("%i/%i", active + 1, itemCount));
...
bool GuiDropdownBox(int windowID, RayRectangle bounds, const char *text, int *active, bool editMode)
{
    GuiState state = guiState;
    ...
    GuiDrawText(items[itemSelected], GetTextBounds(DEFAULT, bounds), GuiGetStyle(DROPDOWNBOX, TEXT_ALIGNMENT), Fade(GetColor(GuiGetStyle(DROPDOWNBOX, GUITEXT + state*3)), guiAlpha));
    ...
    GuiDrawText("v", RAYGUI_CLITERAL(RayRectangle){ bounds.x + bounds.width - GuiGetStyle(DROPDOWNBOX, ARROW_PADDING), bounds.y + bounds.height/2 - 2, 10, 10 },
                TEXT_ALIGN_CENTER, Fade(GetColor(GuiGetStyle(DROPDOWNBOX, GUITEXT + (state*3))), guiAlpha));
#else
    GuiDrawText("#120#", RAYGUI_CLITERAL(RayRectangle){ bounds.x + bounds.width - GuiGetStyle(DROPDOWNBOX, ARROW_PADDING), bounds.y + bounds.height/2 - 6, 10, 10 },
                TEXT_ALIGN_CENTER, Fade(GetColor(GuiGetStyle(DROPDOWNBOX, GUITEXT + (state*3))), guiAlpha));   // ICON_ARROW_DOWN_FILL
#endif
    //--------------------------------------------------------------------
...
bool GuiTextBox(int windowID, RayRectangle bounds, char *text, int textSize, bool editMode)
{
    GuiState state = guiState;
    bool pressed = false;
    ...
    GuiDrawText(text, textBounds, textAlignment, Fade(GetColor(GuiGetStyle(TEXTBOX, GUITEXT + (state*3))), guiAlpha));
...
bool GuiSpinner(int windowID, RayRectangle bounds, const char *text, int *value, int minValue, int maxValue, bool editMode)
{
    GuiState state = guiState;
...
#if defined(RAYGUI_NO_ICONS)
    if (GuiButton(windowID, leftButtonBound, "<")) tempValue--;
    if (GuiButton(windowID, rightButtonBound, ">")) tempValue++;
#else
    if (GuiButton(windowID, leftButtonBound, GuiIconText(ICON_ARROW_LEFT_FILL, NULL))) tempValue--;
    if (GuiButton(windowID, rightButtonBound, GuiIconText(ICON_ARROW_RIGHT_FILL, NULL))) tempValue++;
#endif
    ...
    pressed = GuiValueBox(windowID, spinner, NULL, &tempValue, minValue, maxValue, editMode);
    ...
    GuiDrawText(text, textBounds, (GuiGetStyle(SPINNER, TEXT_ALIGNMENT) == TEXT_ALIGN_RIGHT)? TEXT_ALIGN_LEFT : TEXT_ALIGN_RIGHT, Fade(GetColor(GuiGetStyle(LABEL, GUITEXT + (state*3))), guiAlpha));
    //--------------------------------------------------------------------
...
bool GuiValueBox(int windowID, RayRectangle bounds, const char *text, int *value, int minValue, int maxValue, bool editMode)
{
    ...
    GuiDrawText(textValue, GetTextBounds(VALUEBOX, bounds), TEXT_ALIGN_CENTER, Fade(GetColor(GuiGetStyle(VALUEBOX, GUITEXT + (state*3))), guiAlpha));

    // Draw cursor
    if (editMode)
    {
        // NOTE: ValueBox internal text is always centered
        RayRectangle cursor = { bounds.x + GetTextWidth(textValue)/2 + bounds.width/2 + 2, bounds.y + 2*GuiGetStyle(VALUEBOX, BORDER_WIDTH), 4, bounds.height - 4*GuiGetStyle(VALUEBOX, BORDER_WIDTH) };
        GuiDrawRectangle(cursor, 0, BLANK, Fade(GetColor(GuiGetStyle(VALUEBOX, BORDER_COLOR_PRESSED)), guiAlpha));
    }

    // Draw text label if provided
    GuiDrawText(text, textBounds, (GuiGetStyle(VALUEBOX, TEXT_ALIGNMENT) == TEXT_ALIGN_RIGHT)? TEXT_ALIGN_LEFT : TEXT_ALIGN_RIGHT, Fade(GetColor(GuiGetStyle(LABEL, GUITEXT + (state*3))), guiAlpha));
    //--------------------------------------------------------------------
...
bool GuiTextBoxMulti(int windowID, RayRectangle bounds, char *text, int textSize, bool editMode)
{
    GuiState state = guiState;
    bool pressed = false;

    RayRectangle textAreaBounds = {
    ...
    RayRectangle cursor = { 0, -1, 4, (float)GuiGetStyle(DEFAULT, TEXT_SIZE) + 2 };
    ...
    for (int i = 0, codepointLength = 0; text[i] != '\0'; i += codepointLength)
    {
        ...
        else
        {
            ...
            DrawTextCodepoint(guiFont, codepoint, cursorPos, (float)GuiGetStyle(DEFAULT, TEXT_SIZE), Fade(GetColor(GuiGetStyle(TEXTBOX, GUITEXT + (state*3))), guiAlpha));
...
float GuiSliderPro(int windowID, RayRectangle bounds, const char *textLeft, const char *textRight, float value, float minValue, float maxValue, int sliderWidth)
{
    GuiState state = guiState;
    ...
    if (textLeft != NULL)
    {
        ...
        GuiDrawText(textLeft, textBounds, TEXT_ALIGN_RIGHT, Fade(GetColor(GuiGetStyle(SLIDER, GUITEXT + (state*3))), guiAlpha));
    }
    ...
    if (textRight != NULL)
    {
        ...
        GuiDrawText(textRight, textBounds, TEXT_ALIGN_LEFT, Fade(GetColor(GuiGetStyle(SLIDER, GUITEXT + (state*3))), guiAlpha));
    }
    //--------------------------------------------------------------------
...
float GuiSlider(int windowID, RayRectangle bounds, const char *textLeft, const char *textRight, float value, float minValue, float maxValue)
{
    return GuiSliderPro(windowID, bounds, textLeft, textRight, value, minValue, maxValue, GuiGetStyle(SLIDER, SLIDER_WIDTH));
}

// Slider Bar control extended, returns selected value
float GuiSliderBar(int windowID, RayRectangle bounds, const char *textLeft, const char *textRight, float value, float minValue, float maxValue)
{
    return GuiSliderPro(windowID, bounds, textLeft, textRight, value, minValue, maxValue, 0);
}

// Progress Bar control extended, shows current progress value
float GuiProgressBar(RayRectangle bounds, const char *textLeft, const char *textRight, float value, float minValue, float maxValue)
{
    GuiState state = guiState;
    ...
    if (textLeft != NULL)
    {
        ...
        GuiDrawText(textLeft, textBounds, TEXT_ALIGN_RIGHT, Fade(GetColor(GuiGetStyle(PROGRESSBAR, GUITEXT + (state*3))), guiAlpha));
    }
    ...
    if (textRight != NULL)
    {
        ...
        GuiDrawText(textRight, textBounds, TEXT_ALIGN_LEFT, Fade(GetColor(GuiGetStyle(PROGRESSBAR, GUITEXT + (state*3))), guiAlpha));
    }
    //--------------------------------------------------------------------
...
// Status Bar control
void GuiStatusBar(RayRectangle bounds, const char *text)
{
    GuiState state = guiState;
...
void GuiDummyRec(int windowID, RayRectangle bounds, const char *text)
{
    GuiState state = guiState;
...
// List View control
int GuiListView(int windowID, RayRectangle bounds, const char *text, int *scrollIndex, int active)
{
    int itemCount = 0;
    ...
    return GuiListViewEx(windowID, bounds, items, itemCount, NULL, scrollIndex, active);
}

// List View control with extended parameters
int GuiListViewEx(int windowID, RayRectangle bounds, const char **text, int count, int *focus, int *scrollIndex, int active)
{
    GuiState state = guiState;
    ...
    if (useScrollBar)
    {
        ...
        startIndex = GuiScrollBar(windowID, scrollBarBounds, startIndex, 0, count - visibleItems);
...
// Color Panel control
Color GuiColorPanel(int windowID, RayRectangle bounds, const char *text, Color color)
{
...
float GuiColorBarAlpha(int windowID, RayRectangle bounds, const char *text, float alpha)
{
...
float GuiColorBarHue(int windowID, RayRectangle bounds, const char *text, float hue)
{
    GuiState state = guiState;
...
Color GuiColorPicker(int windowID, RayRectangle bounds, const char *text, Color color)
{
    color = GuiColorPanel(windowID, bounds, NULL, color);
    ...
    hsv.x = GuiColorBarHue(windowID, boundsHue, NULL, hsv.x);
...
// Message Box control
int GuiMessageBox(int windowID, RayRectangle bounds, const char *title, const char *message, const char *buttons)
{
    ...
    // Draw control
    //--------------------------------------------------------------------
    if (GuiWindowBox(windowID, bounds, title)) clicked = 0;
    ...
    {
        if (GuiButton(windowID, buttonBounds, buttonsText[i])) clicked = i + 1;
...
int GuiTextInputBox(int windowID, RayRectangle bounds, const char *title, const char *message, const char *buttons, char *text, int textMaxSize, int *secretViewActive)
{
    ...
    // Draw control
    //--------------------------------------------------------------------
    if (GuiWindowBox(windowID, bounds, title)) btnIndex = 0;
    ...
    {
        static char stars[] = "****************";
        if (GuiTextBox(windowID, RAYGUI_CLITERAL(RayRectangle){ textBoxBounds.x, textBoxBounds.y, textBoxBounds.width - 4 - RAYGUI_TEXTINPUTBOX_HEIGHT, textBoxBounds.height }, 
            ((*secretViewActive == 1) || textEditMode)? text : stars, textMaxSize, textEditMode)) textEditMode = !textEditMode;

        *secretViewActive = GuiToggle(windowID, RAYGUI_CLITERAL(RayRectangle){ textBoxBounds.x + textBoxBounds.width - RAYGUI_TEXTINPUTBOX_HEIGHT, textBoxBounds.y, RAYGUI_TEXTINPUTBOX_HEIGHT, RAYGUI_TEXTINPUTBOX_HEIGHT }, (*secretViewActive == 1)? "#44#" : "#45#", *secretViewActive);
    }
    else
    {
        if (GuiTextBox(windowID, textBoxBounds, text, textMaxSize, textEditMode)) textEditMode = !textEditMode;
    }
    ...
    for (int i = 0; i < buttonCount; i++)
    {
        if (GuiButton(windowID, buttonBounds, buttonsText[i])) btnIndex = i + 1;
        buttonBounds.x += (buttonBounds.width + RAYGUI_MESSAGEBOX_BUTTON_PADDING);
    }
...
Vector2 GuiGrid(int windowID, RayRectangle bounds, const char *text, float spacing, int subdivs)
{
    ...
    if (tryBinary)
    {
            ...
            (signature[3] == ' '))
        {
            ...
            if (fontDataSize > 0)
            {
                ...
                fread(&whiteRec, 1, sizeof(RayRectangle), rgsFile);
...
static void GuiDrawText(const char *text, RayRectangle bounds, int alignment, Color tint)
{
...
static int GuiScrollBar(int windowID, RayRectangle bounds, int value, int minValue, int maxValue)
{
    GuiState state = guiState;
    ...
    arrowUpLeft = RAYGUI_CLITERAL(RayRectangle) { (float)bounds.x + GuiGetStyle(SCROLLBAR, BORDER_WIDTH), (float)bounds.y + GuiGetStyle(SCROLLBAR, BORDER_WIDTH), (float)spinnerSize, (float)spinnerSize };
    ...
    if (isVertical)
    {
        ...
        slider = RAYGUI_CLITERAL(RayRectangle) { (float)bounds.x + GuiGetStyle(SCROLLBAR, BORDER_WIDTH) + GuiGetStyle(SCROLLBAR, SCROLL_SLIDER_PADDING), (float)scrollbar.y + (int)(((float)(value - minValue)/range)*(scrollbar.height - sliderSize)), (float)bounds.width - 2*(GuiGetStyle(SCROLLBAR, BORDER_WIDTH) + GuiGetStyle(SCROLLBAR, SCROLL_SLIDER_PADDING)), (float)sliderSize };
    }
    else
    {
        ...
        slider = RAYGUI_CLITERAL(RayRectangle) { (float)scrollbar.x + (int)(((float)(value - minValue)/range)*(scrollbar.width - sliderSize)), (float)bounds.y + GuiGetStyle(SCROLLBAR, BORDER_WIDTH) + GuiGetStyle(SCROLLBAR, SCROLL_SLIDER_PADDING), (float)sliderSize, (float)bounds.height - 2*(GuiGetStyle(SCROLLBAR, BORDER_WIDTH) + GuiGetStyle(SCROLLBAR, SCROLL_SLIDER_PADDING)) };
    }
    ...
    if ((state != STATE_DISABLED) && !guiLocked)
    {
        ...
        if (CheckCollisionPointRec(mousePoint, bounds))
        {
            ...
            else if (IsMouseButtonDown(MOUSE_LEFT_BUTTON))
            {
                if (!isVertical)
                {
                    RayRectangle scrollArea = { arrowUpLeft.x + arrowUpLeft.width, arrowUpLeft.y, scrollbar.width, bounds.height - 2*GuiGetStyle(SCROLLBAR, BORDER_WIDTH) };
                ...
                {
                    RayRectangle scrollArea = { arrowUpLeft.x, arrowUpLeft.y+arrowUpLeft.height, bounds.width - 2*GuiGetStyle(SCROLLBAR, BORDER_WIDTH),  scrollbar.height };
    ...
    {
#if defined(RAYGUI_NO_ICONS)
        GuiDrawText(isVertical ? "^" : "<", RAYGUI_CLITERAL(RayRectangle){ arrowUpLeft.x, arrowUpLeft.y, isVertical ? bounds.width : bounds.height, isVertical ? bounds.width : bounds.height },
            TEXT_ALIGN_CENTER, Fade(GetColor(GuiGetStyle(DROPDOWNBOX, GUITEXT + (state*3))), guiAlpha));
        GuiDrawText(isVertical ? "v" : ">", RAYGUI_CLITERAL(RayRectangle){ arrowDownRight.x, arrowDownRight.y, isVertical ? bounds.width : bounds.height, isVertical ? bounds.width : bounds.height },
            TEXT_ALIGN_CENTER, Fade(GetColor(GuiGetStyle(DROPDOWNBOX, GUITEXT + (state*3))), guiAlpha));
#else
        GuiDrawText(isVertical ? "#121#" : "#118#", RAYGUI_CLITERAL(RayRectangle){ arrowUpLeft.x, arrowUpLeft.y, isVertical ? bounds.width : bounds.height, isVertical ? bounds.width : bounds.height },
            TEXT_ALIGN_CENTER, Fade(GetColor(GuiGetStyle(SCROLLBAR, GUITEXT + state*3)), guiAlpha));   // ICON_ARROW_UP_FILL / ICON_ARROW_LEFT_FILL
        GuiDrawText(isVertical ? "#120#" : "#119#", RAYGUI_CLITERAL(RayRectangle){ arrowDownRight.x, arrowDownRight.y, isVertical ? bounds.width : bounds.height, isVertical ? bounds.width : bounds.height },
            TEXT_ALIGN_CENTER, Fade(GetColor(GuiGetStyle(SCROLLBAR, GUITEXT + state*3)), guiAlpha));   // ICON_ARROW_DOWN_FILL / ICON_ARROW_RIGHT_FILL
#endif
    }
    //--------------------------------------------------------------------
